...
function create(){
  ...
  pomelo.init = function(params, cb){
    ...
    if (!params.type) {
      if (pomelo.params.debug) console.log('init websocket');
  ...
  pomelo.initWebSocket = function(url,cb){
    if (pomelo.params.debug) console.log(url);
    var onopen = function(event){
      if (pomelo.params.debug) console.log('[pomeloclient.init] websocket connected!');
  ...
  pomelo.disconnect = function() {
    if(socket) {
      ...
      if (pomelo.params.debug) console.log('disconnect');
      socket = null;
    }
